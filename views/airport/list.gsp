                ...
                <table>
                    <thead>
                        <tr>
                   	        ...
                   	        <g:sortableColumn property="iata" title="Iata" />
                    ...
                    <g:each in="${airportList}" status="i" var="airport">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${airport.name?.encodeAsHTML()}</td>
                        
                            <td>${airport.iata?.encodeAsHTML()}</td>
                        
                            <td>${airport.city?.encodeAsHTML()}</td>
                        
                            <td>${airport.state?.encodeAsHTML()}</td>
                        
                            <td>${airport.country?.encodeAsHTML()}</td>
